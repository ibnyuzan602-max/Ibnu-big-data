...
# =========================
# INISIALISASI SESSION STATE PALING AMAN
# =========================
# Gunakan inisialisasi standar untuk menjamin ketersediaan.
...
if os.path.exists(music_folder):
    ...
    if len(music_files) == 0:
        ...
        selected_music = st.sidebar.selectbox(
            "Pilih Lagu:",
            options=music_files,
            # Menggunakan .index() hanya jika file ada, yang sudah dijamin di atas
...
# KUNCI PERBAIKAN: Gunakan .get() dengan default value
